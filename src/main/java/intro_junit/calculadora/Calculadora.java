...
public class Calculadora {
	 ...
	 * 
	 * @param a Primeiro valor a ser adicionado
	 * @param b Segundo valor a ser adicionado
	 ...
	 * 
	 * @param a Primeiro valor a ser subtraído
	 * @param b Segundo valor a ser subtraído
